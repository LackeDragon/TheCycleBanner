...
lib.ssMetadata = [
		{name:"TheCycleBannerDONE_atlas_P_", frames: [[423,368,38,40],[268,373,30,53],[165,373,67,54],[300,368,81,87],[165,429,37,10],[383,417,46,35],[383,368,38,47],[0,252,141,182],[234,373,32,58],[302,0,154,182],[302,184,154,182],[0,436,163,43],[165,457,155,21],[143,252,155,119],[0,0,300,250]]},
		{name:"TheCycleBannerDONE_atlas_NP_", frames: [[0,0,300,250]]}
];
...
(lib.Banling = function() {
	this.initialize(ss["TheCycleBannerDONE_atlas_P_"]);
	this.gotoAndStop(0);
...
(lib.Decor = function() {
	this.initialize(ss["TheCycleBannerDONE_atlas_NP_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.TheCycleBannerDONE = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TheCycleBannerDONE_atlas_P_.png", id:"TheCycleBannerDONE_atlas_P_"},
		{src:"images/TheCycleBannerDONE_atlas_NP_.jpg", id:"TheCycleBannerDONE_atlas_NP_"}
	],
	preloads: []
};
